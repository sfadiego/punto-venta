import { Activity, AlertTriangle, Building2, CreditCard, Palette, Printer, ShieldCheck, Sparkles, Store, Truck, UserPlus, Users } from "lucide-react";
...
const EDIT_SECTIONS = [
    ...
    { id: "sucursales", label: "Sucursales", icon: <Store size={18} /> },
    { id: "roles-permisos", label: "Roles y permisos", icon: <ShieldCheck size={18} /> },
