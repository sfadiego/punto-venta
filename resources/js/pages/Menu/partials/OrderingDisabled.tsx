...
export const OrderingDisabled = ({ business }: OrderingDisabledProps) => {
    return (
        <div className="min-h-screen bg-stone-50 flex flex-col items-center justify-center px-6 text-center">
            ...
            <p className="text-stone-500 text-sm max-w-xs leading-relaxed">
                Los pedidos en línea no están disponibles en este momento. Comunícate directamente con nosotros para hacer tu pedido.
            </p>
        </div>
    );
};
