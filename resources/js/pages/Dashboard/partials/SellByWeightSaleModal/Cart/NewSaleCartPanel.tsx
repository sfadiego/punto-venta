...
export const NewSaleCartPanel = ({
    ...
    <div className="flex flex-col w-full lg:w-72 flex-1 lg:flex-none lg:shrink-0 min-h-0 overflow-hidden bg-stone-50 border-t border-stone-100 lg:border-t-0 lg:bg-white">
