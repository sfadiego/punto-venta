...
export const useQuickSaleOrderLifecycle = ({
    ...
    resetDelivery,
    navigate,
}: UseQuickSaleOrderLifecycleParams) => {
    ...
    const handleNombrePedidoBlur = () => {
        ...
        updateOrderData({
            ...
            .catch((error) => logUnexpectedError(error, "useQuickSaleOrderLifecycle.handleNombrePedidoBlur"));
    };
    ...
    const handleBack = async () => {
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                logUnexpectedError(error, "useQuickSaleOrderLifecycle.saveCartAsInProcess");
